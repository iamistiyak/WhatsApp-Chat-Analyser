...
def fetch_stats(selected_user, df):
    ...
    num_messages = df.shape[0]  # 1. Fetch the number of messages
    ...
    num_media_massages = df[df['message'] == '<Media omitted>\n'].shape[0]
    ...
    return num_messages, len(words), num_media_massages, len(links)
